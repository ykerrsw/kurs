/**
* @file listener.cpp
* @brief Класс listener для вычисления среднего арифметического значений в векторе.
*/
#include "listener.h"
 ...
 * @param logFile Путь к файлу логинов.
 ...
 * Если адрес не соответствует, записывает ошибку в лог файл.
 *
